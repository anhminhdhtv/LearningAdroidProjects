...
public class FragmentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTransferDataFragment = findViewById(R.id.button_add_transfer_data_fragment);
    ...
    public void RemoveTransferFragment(View view){
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        TransferDataFragment transferDataFragment = (TransferDataFragment) fragmentManager.findFragmentByTag("TAG_TRANSFER_FRAGMENT");
        if (transferDataFragment != null){
            fragmentTransaction.remove(transferDataFragment);
            fragmentTransaction.commit();
        }
    }
}