...
public class UserInfoAdapter extends RecyclerView.Adapter<UserInfoAdapter.UserItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull UserItemViewHolder holder, int position) {
        ...
        String birthDay =  simpleDateFormat.format((new Date(userInfo.getDayOfBirth())).getTime());
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((MainActivity)mContext).deleteUser(userInfo.getId());
            }
        });
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivity)mContext).updateUserInfo(userInfo);
            }
        });
    }
